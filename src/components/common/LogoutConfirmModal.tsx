            ...
            >
              ...
              <div className="flex flex-col items-center text-center mt-2">
                ...
                <h3 className="text-xl font-extrabold text-slate-800 mb-2">
                  Logout dari TumbuhSehat?
                </h3>
                
                <p className="text-sm font-semibold text-slate-500 leading-relaxed mb-8 px-2">
                  Anda akan keluar dari sesi saat ini. Anda perlu login kembali untuk mengakses data Anda.
                </p>
                ...
                <div className="flex w-full gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 py-3.5 rounded-2xl bg-rose-500 text-white font-bold hover:bg-rose-600 shadow-lg shadow-rose-500/30 transition-all hover:-translate-y-0.5 active:translate-y-0"
                  >
                    Ya, Logout
                  </button>
                </div>
