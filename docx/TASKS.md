...
| ID | Task | Prioritas | Dependensi |
|----|------|-----------|-----------|
| MOB-001 | [x] Setup project React Native / Expo (TypeScript) | 🔴 Critical | — |
| MOB-002 | [x] Setup React Navigation (stack + tab navigator) | 🔴 Critical | MOB-001 |
| MOB-003 | [x] Setup TanStack Query + Axios instance (base URL, interceptor) | 🔴 Critical | MOB-001 |
| MOB-004 | [x] Setup Zustand store | 🔴 Critical | MOB-001 |
| MOB-005 | [x] Setup expo-secure-store untuk JWT | 🔴 Critical | MOB-001 |
...
| ID | Task | Prioritas | Dependensi |
|----|------|-----------|-----------|
| MOB-101 | [x] Screen Login — form, validasi, error state | 🔴 Critical | MOB-003, BE-102 |
| MOB-102 | [x] Screen Register | 🔴 Critical | MOB-003, BE-101 |
| MOB-103 | [x] Simpan JWT ke SecureStore setelah login | 🔴 Critical | MOB-101 |
| MOB-104 | [x] Auth flow (splash screen cek token → login / home) | 🔴 Critical | MOB-103 |
| MOB-105 | [x] Auto-refresh token | 🔴 Critical | MOB-104, BE-103 |
| MOB-106 | [x] Logout (hapus token dari SecureStore) | 🟡 High | MOB-103, BE-104 |
...
| ID | Task | Prioritas | Dependensi |
|----|------|-----------|-----------|
| MOB-201 | [x] Screen Home — daftar anak (list card), empty state | 🔴 Critical | MOB-104, BE-201 |
| MOB-202 | [x] Screen Tambah Anak — form + validasi | 🔴 Critical | MOB-201, BE-202 |
| MOB-203 | [x] Screen Detail Anak — info dasar + tab navigator | 🟡 High | MOB-202, BE-203 |
