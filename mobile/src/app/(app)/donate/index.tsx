...
import { usePoolStats } from '@/features/donate/hooks/usePoolStats'
import { ETHERSCAN_URL, CONTRACT_ADDRESS } from '@/features/donate/config'
...
export default function DonateIndexScreen() {
  ...
  const handleDonatePress = useCallback(() => {
    router.push('/(app)/donate/form' as never)
  }, [router])
  ...
  return (
    ...
    >
      <View className="bg-green-600 px-5 pt-8 pb-10">
